...
public final class IdentityCredentialStore {
    private static final String ALIAS="cn.jhun.sanjiaohu.identity.v1";
    ...
    private static AtomicFile file(Context c){return new AtomicFile(new File(c.getNoBackupFilesDir(),"identity-login.enc"));}
